...
namespace CSarp_Car_Rental_System
{
    class db
    {
        ...
        public static string _Access = @"Data Source=WINDOW1\SQLEXPRESS;Initial Catalog=RentalCar;Integrated Security=True;User ID=sa";

        //Data Source=WINDOW1\SQLEXPRESS;Initial Catalog=RentalCar;Integrated Security=True
